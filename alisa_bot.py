users = set()
ADMIN_ID = 6623731991 # O‘zingizning Telegram ID’ingizni shu yerga yozing
    reply_markup = ReplyKeyboardMarkup(menu, resize_keyboard=True)
    await update.message.reply_text(
        "Salom! Men Alisa botman. Talabalarga yordam beraman. Qaysi bo‘limga murojaat qilmoqchisiz?",
...
async def stop(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("⛔ Bot to‘xtatildi. Xayr! Salomat bo'ling

# Ijara shartnomasi bo‘yicha maslahat
...
# TTJga joylashish bo‘yicha maslahat
...
# Komandalar va tugmalarni bog‘lash
